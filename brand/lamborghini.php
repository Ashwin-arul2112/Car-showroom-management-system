<?php
  ...
  $res=mysqli_query($con,"select * from carss where brand='lamborghini'");
?>
<!DOCTYPE html>
<html><head><title>LAMBORGHINI</title><link rel="stylesheet" href="stylebmw.css"></head>
<body class="bgbmw">
<nav class="navbar">
...
<?php
  while($row=mysqli_fetch_array($res)){
    ...
    echo '<a href="../book.php?cn='.$row['name'].'"><img class="expand" src="'.$row['img'].'"></a>';
    echo '</div>';
    echo '</div>';
    echo '<br>';
  }
